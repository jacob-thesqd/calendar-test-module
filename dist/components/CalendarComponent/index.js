...
import { EventCalendar, } from "@/registry/default/components/event-calendar";
...
export default function Component() {
    var _a = useState(sampleEvents), events = _a[0], setEvents = _a[1];
    ...
    var handleEventDelete = function (eventId) {
        setEvents(events.filter(function (event) { return event.id !== eventId; }));
    };
    return (_jsx(EventCalendar, { events: events, onEventAdd: handleEventAdd, onEventUpdate: handleEventUpdate, onEventDelete: handleEventDelete }));
}
